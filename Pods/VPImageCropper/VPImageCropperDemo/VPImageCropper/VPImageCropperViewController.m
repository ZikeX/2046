...
//    self.ratioView = [[UIView alloc] initWithFrame:CGRectMake(self.cropFrame.origin.x, self.cropFrame.origin.y, self.cropFrame.size.width, self.cropFrame.size.width * 3/4)];
